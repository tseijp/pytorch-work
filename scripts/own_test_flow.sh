...
python own_test_video.py --name everybody_dance_now_temporal --model pose2vid --dataroot ./datasets/ --which_epoch 80 --netG local --ngf 32 --label_nc 0 --no_instance --resize_or_crop scale_width --loadSize 512
