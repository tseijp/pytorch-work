...
from models.pose2vidHD_model import Pose2VidHDModel
...
for epoch in tqdm(range(start_epoch, opt.niter + opt.niter_decay + 1)):# my changed
    epoch_start_time = time.time()
    if epoch != start_epoch:
        epoch_iter = epoch_iter % dataset_size
    for i, data in tqdm(enumerate(dataset, start=epoch_iter)):# my changed
